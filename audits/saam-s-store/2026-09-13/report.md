...
<!-- TODO: Write the summary — see references/reporting.md. Do not send the report with this marker still in it. -->

3 medium · 10 low · 2 info

## What we measured

- `https://saam-s-store.vercel.app/` (mobile) — LCP 2.06 s, CLS 0.003, TBT 244 ms, TTFB 41 ms, 778 kB over 58 requests
- `https://saam-s-store.vercel.app/` (desktop) — LCP 880 ms, CLS 0.001, TBT 0 ms, TTFB 41 ms, 979 kB over 67 requests
- `https://saam-s-store.vercel.app/shop` (mobile) — LCP 1.74 s, CLS 0.000, TBT 283 ms, TTFB 35 ms, 745 kB over 97 requests
- `https://saam-s-store.vercel.app/shop` (desktop) — LCP 1.47 s, CLS 0.000, TBT 0 ms, TTFB 40 ms, 674 kB over 121 requests
- `https://saam-s-store.vercel.app/products/apple` (mobile) — LCP 1.51 s, CLS 0.001, TBT 252 ms, TTFB 39 ms, 371 kB over 47 requests
- `https://saam-s-store.vercel.app/products/apple` (desktop) — LCP 1.14 s, CLS 0.000, TBT 0 ms, TTFB 38 ms, 356 kB over 49 requests
- `https://saam-s-store.vercel.app/cart` (mobile) — LCP 2.90 s, CLS 0.000, TBT 250 ms, TTFB 34 ms, 328 kB over 39 requests
- `https://saam-s-store.vercel.app/cart` (desktop) — LCP 644 ms, CLS 0.001, TBT 0 ms, TTFB 36 ms, 324 kB over 39 requests
...
### Main content takes too long to appear (LCP 2.90 s)  
`[Medium · Quick fix]`

**What we found.**
```
LCP 2.90 s — median of 3 cold loads, Moto G-class Android, 4G. Threshold for "good" is 2.50 s.
```

**Why it matters.** On Moto G-class Android, 4G, the largest thing on screen finishes drawing after 2.90 s. Google treats anything over 2.5 seconds as poor; it affects both search ranking and how many visitors leave before the page is usable.
...
<!-- TODO: Write the plan — see references/reporting.md. Do not send the report with this marker still in it. -->
