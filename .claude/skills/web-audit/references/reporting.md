...
2. **Whoever built the site**, meaning an agency, a freelancer or a nephew. The owner
...
2. What we measured            method, date, URLs, profile, tools. Keep short
...
> Both are fixable in under a day, without redesigning anything.
>
...
page can read the token and use it to act as that user, whether that is a
compromised analytics tag, an ad, or a cross-site scripting bug. With the flag set, the browser
...
- **The heading is the finding**, in plain words. Not "CWE-1004" and not
  "Cookie misconfiguration", but a sentence a non-technical reader understands.
